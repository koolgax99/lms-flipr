<template>
  <v-card class="mx-auto p-4" width="700" raised>
    <v-form ref="form" v-model="valid" lazy-validation enctype="multipart/form-data">
      ...
      <br>
      <div v-if="assignments.classroom_id != '' && radio =='Classroom'">
      ...
      <div v-if="assignments.batch_id != '' && radio == 'Batch'">
        <v-select v-model="assignments.subject_id"
      ...
      <br>
      <br>
      <v-radio-group v-model="assignments.send_email" >
        <p>Do you want to send notification email to all students?</p>
...
<script>
  export default {
    ...
    methods: {
      ...
      submit() {
        this.errors = {}
        console.log(this.assignments.start_date_and_time);
        console.log(this.assignments.end_date_and_time);
        axios
