...
<script>
  export default {
    ...
    created(){
      let url = process.env.MIX_APP_URL + `/api/study-materials/${this.$route.params.id}/edit`;
      this.axios.get(url)
      .then(response =>{
        console.log(response.data);
        this.materials = response.data;
        if((this.materials.classroom_id == null || this.materials.classroom_id == '') && (this.materials.batch_id != null || this.materials.batch_id != '') )
        {
          this.radio = 'Batch';

          console.log(this.radio)
          axios.get(`batches/${this.materials.batch_id}/subjects`)
          .then(response =>{
        ...
        else
        {
          ...
          axios.get(`classrooms/${this.materials.classroom_id}/subjects`)
          .then(response =>{
    ...
    methods: {
      ...
      submit() {
        this.errors = {}
        axios
          .put(`/study-materials/${this.$route.params.id}/update`, this.materials)
          .then(response => {
